...
\begin{itemize}
    \item For better formating, I have removed the pictures from last week's task. They can still be found in the attached source code under \textit{report/images/}.
    ...
    \item I have fully finished implementing the user interactivity of Task 1 (filtering, brushing, tooltips).
\end{itemize}}
